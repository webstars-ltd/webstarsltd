      ...
      >
        {!darkMode.value ? (
          <svg
            ...
            className="dark:hidden w-5 h-5 text-gray-800 dark:text-dark-contrastText "
          >
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="tailwind-hidden dark:block w-5 h-5 text-gray-800 dark:text-dark-contrastText "
          >
            <path
